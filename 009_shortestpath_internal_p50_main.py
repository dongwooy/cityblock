...
for starea in studyareas:
	...
	basenetwork = '.../walk_effi_2nd/' + starea + '/002_grid_50_45_line.shp'
	...
	#     Assign the empty list of shortest distances (list name : pathlen) the shortest distances measured from the list dG:
