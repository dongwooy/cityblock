...
pa00 = []
output = '.../011_pa00_ext_twy_ns.txt'

for starea in studyareas:
   	filename = '.../walk_effi_2nd/' + starea + '/001_nsew_xy_twy_ns.txt'
	filename2 = '.../walk_effi_2nd/' + starea + '/001_nsew_xy_twy_ns.txt'
