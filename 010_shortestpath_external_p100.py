...
studyareas = ['0606','0633','0670','0717','0995','1009','1079','1132','1135','1332',
              '1373','1539','1552','1781','1861','2015','2589','2874']

pa100 = []
output = '.../cityblock2/011_pa100_ext_2.txt'

for starea in studyareas:
   	filename = '.../cityblock2/walk_effi_2nd/' + starea + '/001_nsew_xy.txt'
	filename2 = '.../cityblock2/walk_effi_2nd/' + starea + '/001_nsew_xy.txt'
	basenetwork = '.../cityblock2/walk_effi_2nd/' + starea + '/002_grid_100_45_line.shp'
    # Pre-defined data1: Location of buildings (x/y) inside a residential area in meter
	#filename = '.../cityblock2/walk_effi_2nd/0057/001_aptent_xy.txt'
	...
	#filename2 = '.../cityblock2/walk_effi_2nd/0057/001_nsew_xy.txt'
	...
	#     For instance, if there are 11 buildings in a residential area, the length of a list of coordinate elements for the buildings is 44 and seems as following:
	...
	#basenetwork = ".../cityblock2/walk_effi_2nd/0057/002_grid_50_45_line.shp"
	...
	for o in range(0,len(df)):
		...
		w = sum(dl)
		pathlen.append(w)
	# Group the distance elements in pathlen by building and create a new list (list name: sublist) and it seems as following:
